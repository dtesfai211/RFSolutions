...
const translations: Record<LanguageCode, Record<TranslationKey, string>> = {
  ...
  "team.description": "A diverse group of experienced professionals united by a shared passion for helping businesses thrive in the UAE and beyond.",
    ...
    "faq.description": "Find answers to common questions about our services and the business setup process.",
    "faq.q1": "What services do you offer?",
    "faq.a1": "We offer business setup, trade licensing, office solutions, visa processing, corporate banking, and consulting.",
    "faq.q2": "How long does the business setup process take?",
    "faq.a2": "The process usually takes 2-3 weeks, but may vary depending on your business structure and licensing jurisdiction.",
    "faq.q3": "What are the costs involved in setting up a business?",
    "faq.a3": "Our packages start from $1,999. Pricing depends on your business activity, location, and service level.",
    "faq.q4": "Do I need to be physically present during the setup process?",
    "faq.a4": "Many steps can be done remotely. Some may require your presence, depending on the license type.",
    "faq.q5": "What documents are required for business setup?",
    "faq.a5": "Generally, you’ll need passport copies, visa/residency documents, trade name reservation, and tenancy contracts.",
    "faq.q6": "Can you help with opening a corporate bank account?",
    "faq.a6": "Yes, we assist with documentation and introductions to reliable banking partners in the UAE.",
    "faq.q7": "What types of business structures are available?",
    "faq.a7": "Mainland LLC, Free Zone Company, Offshore Entity, and Branch Office are all available options.",
    "faq.q8": "Do you offer ongoing support after business setup?",
    "faq.a8": "Yes, including renewals, accounting, tax filing, legal services, and business growth consulting.",
    "faq.q9": "Can I upgrade my package later?",
    "faq.a9": "Yes. You can upgrade at any time by paying the difference between packages.",
    "faq.q10": "What is the difference between mainland and free zone companies?",
    "faq.a10": "Mainland companies operate anywhere in the UAE; Free Zones offer tax benefits and full ownership.",
    "faq.still.title": "Still Have Questions?",
    "faq.still.description": "Our team is here to help you with any questions you may have.",
    "faq.still.contact": "Contact Us",
    "faq.still.schedule": "Schedule a Consultation",
  ...
  ru: {
    ...
    "faq.description": "Получите ответы на самые распространенные вопросы о наших услугах и процессе открытия бизнеса в ОАЭ.",
    "faq.q1": "Какие услуги вы предоставляете?",
    "faq.a1": "Мы предоставляем услуги по открытию бизнеса, лицензированию, аренде офисов, визовой поддержке, открытию банковских счетов и бизнес-консалтингу.",
    "faq.q2": "Сколько времени занимает процесс регистрации компании?",
    "faq.a2": "Обычно 2–3 недели, в зависимости от типа бизнеса и лицензии.",
    "faq.q3": "Каковы расходы на открытие компании?",
    "faq.a3": "Цены начинаются от $1999. Стоимость зависит от типа деятельности и выбранной зоны.",
    "faq.q4": "Нужно ли мое личное присутствие при открытии компании?",
    "faq.a4": "Некоторые шаги можно выполнить удаленно, но в некоторых случаях требуется личное присутствие.",
    "faq.q5": "Какие документы необходимы для регистрации?",
    "faq.a5": "Паспорта, визы, бронь названия компании, договор аренды и бизнес-план.",
    "faq.q6": "Помогаете ли вы с открытием корпоративного счета?",
    "faq.a6": "Да, мы помогаем подготовить документы и связаться с банками ОАЭ.",
    "faq.q7": "Какие существуют формы ведения бизнеса?",
    "faq.a7": "LLC, компания в свободной зоне, оффшорная компания, представительство иностранной компании.",
    "faq.q8": "Оказываете ли вы поддержку после регистрации?",
    "faq.a8": "Да, мы предоставляем услуги по продлению лицензий, бухгалтерии, налогам и юридическим вопросам.",
    "faq.q9": "Можно ли позже обновить выбранный пакет услуг?",
    "faq.a9": "Да, вы можете перейти на более высокий пакет, оплатив разницу в стоимости.",
    "faq.q10": "В чем разница между компаниями на материке и в свободной зоне?",
    "faq.a10": "Материковые компании могут работать по всей стране, свободные зоны дают 100% иностранное владение и налоговые льготы.",
    "faq.still.title": "Остались вопросы?",
    "faq.still.description": "Наша команда с радостью поможет вам и ответит на все вопросы.",
    "faq.still.contact": "Связаться с нами",
    "faq.still.schedule": "Записаться на консультацию",
  ...
  "team.description": "فريق متنوع من المحترفين ذوي الخبرة يجمعهم شغف مشترك لمساعدة الأعمال على النجاح في الإمارات وخارجها.",
    ...
    "faq.description": "اكتشف إجابات لأكثر الأسئلة شيوعًا حول خدماتنا وعملية تأسيس الأعمال.",
    "faq.q1": "ما هي الخدمات التي تقدمونها؟",
    "faq.a1": "نقدم خدمات تأسيس الشركات، إصدار الرخص التجارية، حلول المكاتب، معالجة التأشيرات، فتح الحسابات المصرفية، والاستشارات.",
    "faq.q2": "كم تستغرق عملية تأسيس الشركة؟",
    "faq.a2": "عادةً ما تستغرق من 2 إلى 3 أسابيع، حسب نوع الشركة والجهة المختصة بإصدار الترخيص.",
    "faq.q3": "ما هي التكاليف المتوقعة لتأسيس شركة؟",
    "faq.a3": "تبدأ باقاتنا من ١٩٩٩ دولارًا. تختلف الأسعار حسب نوع النشاط، الموقع، ومستوى الخدمة.",
    "faq.q4": "هل أحتاج إلى الحضور شخصيًا أثناء إجراءات التأسيس؟",
    "faq.a4": "يمكن تنفيذ العديد من الإجراءات عن بُعد، ولكن قد تتطلب بعض الخطوات حضورك الشخصي.",
    "faq.q5": "ما هي المستندات المطلوبة لتأسيس الشركة؟",
    "faq.a5": "نسخ جواز السفر، الإقامة أو التأشيرة، شهادة حجز الاسم التجاري، وعقد الإيجار من أهم الوثائق المطلوبة.",
    "faq.q6": "هل تساعدون في فتح حساب مصرفي للشركة؟",
    "faq.a6": "نعم، نساعدك في تجهيز المستندات والتواصل مع البنوك المناسبة داخل دولة الإمارات.",
    "faq.q7": "ما هي أنواع الهياكل القانونية المتوفرة؟",
    "faq.a7": "شركة ذات مسؤولية محدودة (LLC)، شركة منطقة حرة، شركة أوفشور، وفرع لشركة أجنبية.",
    "faq.q8": "هل تقدمون دعمًا بعد تأسيس الشركة؟",
    "faq.a8": "نعم، نقدم خدمات المتابعة مثل تجديد التراخيص، المحاسبة، الضرائب، والخدمات القانونية.",
    "faq.q9": "هل يمكنني ترقية الباقة لاحقًا؟",
    "faq.a9": "نعم، يمكنك ترقية الباقة في أي وقت بدفع الفرق بين الباقات.",
    "faq.q10": "ما الفرق بين الشركات في البر الرئيسي والمناطق الحرة؟",
    "faq.a10": "شركات البر الرئيسي يمكنها العمل في جميع أنحاء الإمارات، أما شركات المناطق الحرة فتتميز بملكية أجنبية كاملة وحوافز ضريبية.",
    "faq.still.title": "هل لديك المزيد من الأسئلة؟",
    "faq.still.description": "فريقنا مستعد لمساعدتك والإجابة عن جميع استفساراتك.",
    "faq.still.contact": "اتصل بنا",
    "faq.still.schedule": "احجز استشارة مجانية",
